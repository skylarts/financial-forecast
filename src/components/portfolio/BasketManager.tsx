...
export function BasketManager({
  ...
  return (
    <div>
      ...
      >
        <h3 className="flex items-baseline gap-1.5 text-[13px] font-semibold text-foreground">
          <span aria-hidden className={`text-[9px] text-dim-2 ${open ? "rotate-90" : ""} inline-block`}>
            ▶
          </span>
          Baskets
        </h3>
